...
Just copy your video files with embedded subtitle to this folder and drop them on srt-extractor.bat. An "exports" folder will appear with your data in SRT format.

You can then visualise and convert the files into other formats here: http://tailorandwayne.com/dji-srt-viewer
